...
namespace tinyobj {
	...
	/// or not.
	inline bool LoadObj(std::vector<shape_t> &shapes,       // [output]
	...
	inline void LoadMtl(std::map<std::string, int> &material_map, // [output]
		std::vector<material_t> &materials,       // [output]
...
#define IS_NEW_LINE( x ) ( ( (x) == '\r') || ( (x) == '\n') || ( (x) == '\0') )
		...
		for (size_t i = 0; i < faceGroup.size(); i++) {
			...
			if (triangulate) {
				...
				for (size_t k = 2; k < npolys; k++) {
					...
					shape.mesh.positions.push_back(in_positions[3 * i0.v_idx + 0]);
					shape.mesh.positions.push_back(in_positions[3 * i0.v_idx + 1]);
					shape.mesh.positions.push_back(in_positions[3 * i0.v_idx + 2]);
					shape.mesh.positions.push_back(in_positions[3 * i1.v_idx + 0]);
					shape.mesh.positions.push_back(in_positions[3 * i1.v_idx + 1]);
					shape.mesh.positions.push_back(in_positions[3 * i1.v_idx + 2]);
					shape.mesh.positions.push_back(in_positions[3 * i2.v_idx + 0]);
					shape.mesh.positions.push_back(in_positions[3 * i2.v_idx + 1]);
					shape.mesh.positions.push_back(in_positions[3 * i2.v_idx + 2]);

					shape.mesh.texcoords.push_back(in_texcoords[2 * i0.vt_idx + 0]);
					shape.mesh.texcoords.push_back(in_texcoords[2 * i0.vt_idx + 1]);
					shape.mesh.texcoords.push_back(in_texcoords[2 * i1.vt_idx + 0]);
					shape.mesh.texcoords.push_back(in_texcoords[2 * i1.vt_idx + 1]);
					shape.mesh.texcoords.push_back(in_texcoords[2 * i2.vt_idx + 0]);
					shape.mesh.texcoords.push_back(in_texcoords[2 * i2.vt_idx + 1]);

					shape.mesh.normals.push_back(in_normals[3 * i0.vn_idx + 0]);
					shape.mesh.normals.push_back(in_normals[3 * i0.vn_idx + 1]);
					shape.mesh.normals.push_back(in_normals[3 * i0.vn_idx + 2]);
					shape.mesh.normals.push_back(in_normals[3 * i1.vn_idx + 0]);
					shape.mesh.normals.push_back(in_normals[3 * i1.vn_idx + 1]);
					shape.mesh.normals.push_back(in_normals[3 * i1.vn_idx + 2]);
					shape.mesh.normals.push_back(in_normals[3 * i2.vn_idx + 0]);
					shape.mesh.normals.push_back(in_normals[3 * i2.vn_idx + 1]);
					shape.mesh.normals.push_back(in_normals[3 * i2.vn_idx + 2]);
	...
	inline bool MaterialFileReader::operator()(const std::string &matId,
		...
		std::ifstream matIStream(("Models/" + filepath).c_str());
